...
def training_loop(
    ...
    misc.save_image_grid(grid_reals, dnnlib.make_run_dir_path(
        'reals.jpg'), drange=training_set.dynamic_range, grid_size=grid_size)
    ...
    misc.save_image_grid(grid_fakes, dnnlib.make_run_dir_path(
        'fakes_init.jpg'), drange=drange_net, grid_size=grid_size)
    ...
    while cur_nimg < total_kimg * 1000:
        ...
        if cur_tick < 0 or cur_nimg >= tick_start_nimg + sched.tick_kimg * 1000 or done:
            ...
            if image_snapshot_ticks is not None and (cur_tick % image_snapshot_ticks == 0 or done):
                ...
                misc.save_image_grid(grid_fakes, dnnlib.make_run_dir_path(
                    'fakes%06d.jpg' % (cur_nimg // 1000)), drange=drange_net, grid_size=grid_size)
