...
def run(dataset, data_dir, result_dir, config_id, num_gpus, total_kimg, gamma, mirror_augment, metrics, image_snapshot_ticks, network_snapshot_ticks, resume_pkl, lr, glr, dlr):
...
def main():
    ...
    parser.add_argument('--image_snapshot_ticks',
                        help='How often to save an image snapshot.', default=1, type=int, metavar='N')
    parser.add_argument('--network_snapshot_ticks',
                        help='How often to save a network snapshot.', default=4, type=int, metavar='N')
    parser.add_argument(
        '--resume_pkl', help='Set the path to the desired pkl to resume training from, or find the latest pkl.', default='latest')
    parser.add_argument('--lr', help='base learning rate',
                        default=0.002, type=float)
    parser.add_argument(
        '--glr', help='overwrite base learning rate for G', default=None, type=float)
    parser.add_argument(
        '--dlr', help='overwrite base learning rate for D', default=None, type=float)
